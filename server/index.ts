/**
 * Main server entry point for the Plaiground application.
...
app.use((req, res, next) => {
  ...
  // Log API requests upon completion
  res.on("finish", () => {
...
// Self-executing async function to setup routes and start server
(async () => {
  ...
  // This must be after all other routes to act as a catch-all
